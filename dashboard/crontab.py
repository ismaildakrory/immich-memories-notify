...
DEFAULT_CONFIG = {
    ...
    "settings": {
        ...
        "notification_windows": [
            {"start": "08:00", "end": "09:00", "events": ["memory", "person", "album", "then_and_now", "trip_highlights", "collage"]},
            {"start": "10:00", "end": "12:00", "events": ["memory", "person", "album", "then_and_now", "trip_highlights", "collage"]},
            {"start": "13:00", "end": "15:00", "events": ["memory", "person", "album", "then_and_now", "trip_highlights", "collage"]},
            {"start": "17:00", "end": "19:00", "events": ["memory", "person", "album", "then_and_now", "trip_highlights", "collage"]},
            {"start": "20:00", "end": "22:00", "events": ["memory", "person", "album", "then_and_now", "trip_highlights", "collage"]},
        ],
    },
    "messages": [
